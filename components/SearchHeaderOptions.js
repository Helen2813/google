...
function SearchHeaderOptions() {
  ...
  return (
    ...
    >
      <SearchHeaderOption
        title="All" Icon={SearchIcon} selected={router.query.searchTyp === '' || !router.query.searchType}
      />
      <SearchHeaderOption
        title="Images" Icon={PhotographIcon} selected={router.query.searchType === 'image'}
      />
    </div>
  );
}
